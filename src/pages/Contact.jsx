            ...
            <form ref={form} onSubmit={sendEmail}>
              <div className="help box-question flex w-full justify-between border-b-2 pb-10 overflow-hidden">
                ...
                <div className="radio-button-box w-2/3 flex flex-col gap-2 ">
                  ...
                  <label htmlFor="backend" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.help === `backend` && `border-black`}`}>
                    Backend Development
                    <input type="radio" checked={selectedValue.help === "backend"} onChange={handleChange} id="backend" name="help" value="backend" />
                  </label>
                  <label htmlFor="wordpress" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.help === `wordpress` && `border-black`}`}>
              ...
              <div className="about box-question flex w-full justify-between border-b-2 pb-10 pt-10 overflow-hidden">
                <h3 className="about-text w-3/3 text-3xl font-soehne mr-7">Tell me about your Project</h3>
                <div className="radio-button-box w-2/3 flex flex-col gap-2 ">
                  ...
                  <label htmlFor="other" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.about === `other` && `border-black`}`}>
                    Other
              ...
              <div className="deadline box-question flex w-full justify-between border-b-2 pb-10 pt-10 overflow-hidden">
                ...
                <div className="radio-button-box w-2/3 flex flex-col gap-2 ">
                  ...
                  <label htmlFor="3" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.deadline === `3` && `border-black`}`}>
                    6 - 12 Month
                    <input type="radio" checked={selectedValue.deadline === "3"} onChange={handleChange} id="3" name="deadline" value="3" />
                  </label>
                  <label htmlFor="ongoing" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.deadline === `ongoing` && `border-black`}`}>
                    Ongoing Work
                    <input type="radio" checked={selectedValue.deadline === "ongoing"} onChange={handleChange} id="ongoing" name="deadline" value="ongoing" />
                  </label>
                  <label htmlFor="others" className={`radio-grup w-full flex justify-between border-2 border-slate-3 px-3 py-4 rounded-3xl font-soehne ${selectedValue.deadline === `other` && `border-black`}`}>
                    Other
              ...
              <div className="contact box-question flex w-full justify-between pb-10 pt-10">
                ...
                <div className="contact-info w-2/3 flex flex-col gap-4">
                  ...
                  <div className="email flex flex-col">
                    <label htmlFor="email" className="fn font-soehne">
                  ...
                  <div className="company flex flex-col">
                    <label htmlFor="company" className="company font-soehne">
                      Company
                    </label>
                  ...
                  <div className="message flex flex-col">
                    <label htmlFor="message" className="font-soehne">
                      Message
                    </label>
