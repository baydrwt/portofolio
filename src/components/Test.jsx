...
export default function Technology() {
  ...
  return (
    <section className="technology w-full mb-10 flex mt-10" ref={triggerRef}>
      <div className="box-technology border-4 rounded-xl border-black relative h-full w-full overflow-hidden p-7">
        <h2 className="text-tech font-soehne text-2xl leading-normal tracking-wider">Technology</h2>
        <MyIcon className="technology-svg -mt-14" />
      </div>
    </section>
  );
}
